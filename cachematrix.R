...
##can cache its inverse. cacheSolve: This function computes the inverse of 
##the special “matrix” returned by makeCacheMatrix above. If the inverse has 
...
##matrix can be done with the solve function in R. For example, if X is a square 
